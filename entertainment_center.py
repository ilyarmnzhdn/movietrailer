...
logan = media.Movie("Logan", "In the near future, a weary Logan cares for an ai"
                    "ling Professor X in a hide out on the Mexican border. But "
                    "Logan's attempts to hide from the world and his legacy are"
                    " up-ended when a young mutant arrives, being pursued by da"
                    "rk forces.",
